  ...
  switch (action.type) {
    ...
    case "RED_EXPENSE":
      ...
      return {
        ...
        // No need to update budget here as it's not being handled in the same way as ADD_EXPENSE
      };
    ...
    case "DELETE_EXPENSE":
      ...
      const budget =
        state.budget +
        state.expenses.find((expense) => expense.name === action.payload).cost;
      return {
        ...state,
...
export const AppProvider = (props) => {
  ...
  const [remaining, setRemaining] = useState(
    state.budget - totalExpenses(state.expenses)
  );
